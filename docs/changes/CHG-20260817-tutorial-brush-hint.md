...
- 根据后续视觉反馈移除顶部矩形目标卡片，并将教程提示扩大为 `600×136px`。
...
- 提示条尺寸为 `600×136px`，标题、正文与右侧收起/展开入口均处于墨条安全区内。
...
- Godot 导入素材成功；教程墨条显示尺寸 `600×136px`，使用独立金色 `19px` 标题与米白 `18px` 正文，二者均为纯黑 `4px` 描边。
