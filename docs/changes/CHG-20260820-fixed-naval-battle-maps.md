...
| 岩山岛 | `rocky_island_v1` | `broken_rock_skerry_v1` | 上方新破碎岩礁群与右侧偏置岩山形成两段不可通行障碍，迫使舰船绕行 |
| 港口小镇 | `harbor_town_v1` | `reed_sandbar_v1` | 上方新芦苇沙洲、中部港镇，南向港池深水可供小型舰驶入停泊 |
| 河口岛 | `river_mouth_island_v2` | `reef_shoal_impassable_v2` | `8×10` 河口岛下移，重新生成的不可进入险礁仍在岛屿上方，两者之间固定留出两行深水通道 |
...
- 四张地图分别使用草地沙洲、破碎岩礁群、芦苇沙洲和险礁伴生印章；新生成或重做的后三种印章整个占格矩形统一写为陆地阻挡格，不允许任何舰型进入。
