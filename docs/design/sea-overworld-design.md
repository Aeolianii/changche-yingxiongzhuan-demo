...
- “雾中可疑身影”在海图上从三张浓白雾、低对比淡黑剪影中随机选择一种，并用边缘透明衰减自然融入海面；接触前不显示海怪颜色、面部或材质细节。玩家接触后可选择“靠近查看”或“绕行”；靠近才揭示对应海怪立绘，并提供“战斗系统尚未接入，此战默认获胜”的占位战斗选项。胜利后显示战胜海怪，真实获得木材 `500`、铁石 `500`；绕行无奖励。
