...
- B 区承担敌方核心海域，三个主要地点改为斜向递进关系，右上大型港城成为终局视觉地标。
- C 区承担危险外海，只保留两个高体量地标；另外两个现有地点缩减为沙洲聚落与破碎遗迹岛群，并用暗礁、沉船和狭长岛链增加信息量。
- D 区承担群岛水战空间，岛群向左上疏散，组织成宽阔主航道、狭窄礁峡和南部绕行航道。
- 16 个现有地点名称和交互职责在构图阶段全部保留，阶段一只确定视觉层级与坐标草案，不直接修改游戏运行内容。

北线为“南海军港—东湾水寨—红湾卫所—南澳商港”；南线为“川山渔村—澄海灯岛—龙门海寨—雾岚群岛—月环商港”，再由 B/D 接缝回到南澳商港。四条分块接缝都必须用岛链、礁石走向或航道开口建立跨区联系，避免出现独立画布感。
