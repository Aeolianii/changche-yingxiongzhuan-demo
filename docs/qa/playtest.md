...
| 劝降像素水墨牒文 | 分别进入教学关、普通关和随机遭遇，满足我方劝降或敌方提议条件 | 查看单按钮与双按钮状态 | 所有关卡均使用 520×200px 冷青灰布帛/海浪墨晕底板；20px 金色标题、16px 深墨正文；紧凑朱砂主按钮与墨青拒绝按钮居中，无缺图、旧矩形卡片和内容拥挤 | passed / focused UI assertions + OpenGL captures 2026-08-17 |
