...
|---|---|---|---|---|
| 海域探索白色水墨迷雾 | 新游戏进入海上大地图，并打开完整海图 | 分别观察航行画面四周未知海域、完整海图未知区域与探索边缘，再航行揭示新区域 | 两处未知区域都复用海战白色像素水墨海雾，不出现黑色遮罩或矩形平铺缝；已探索区域、地点显隐、玩家标记和永久探索规则不变 | passed / focused headless + 1344×896 OpenGL captures 2026-08-18 |
