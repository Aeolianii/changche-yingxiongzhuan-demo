...
|---|---|---|---|---|
| 海域探索连续白色水墨迷雾 | 新游戏进入海上大地图，并打开完整海图 | 分别观察大块未知海域、完整海图四边与探索边缘，再航行揭示新区域 | 两处未知区域直接复用海战白色像素水墨雾，以六层大笔触形成连续雾幕；无黑色遮罩、矩形平铺缝、规律蓝色间隔或成排透明孔洞；已探索区域、地点显隐、玩家标记和永久探索规则不变 | passed / focused headless + 1344×896 OpenGL captures 2026-08-18 |
