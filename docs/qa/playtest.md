...
| 雾中海怪事件 | 分别固定三种海怪变体并接触雾影 | 依次选择绕行；另选择靠近查看、默认获胜 | 三种浓雾淡黑剪影与立绘一一对应；初始按钮为“靠近查看 / 绕行”；绕行无奖励；默认获胜显示战胜海怪并获得木材、铁石各 500 | passed / three-variant branch suite + Vulkan capture 2026-08-14 |
