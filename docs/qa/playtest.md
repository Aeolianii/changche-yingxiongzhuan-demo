...
- 峡湾必须读成两侧高岩夹出连续纵向水道，上下均保留外海绕行；水道不可被陆地掩码截断。
- 群岛至少包含四个彼此分离的陆地组件，岛间必须存在从左至右贯通的深水穿插路线。
- 孤岛只能有一座中央主岛，岛体上下两侧均保持完整深水，舰船可从四面绕行。
- 半岛必须从地图上边界连续伸入海面并形成可读内湾，印章下方保留完整深水绕行线。
- 泻湖中央内湖为深水，左右开口连续连接外海，不得形成只能观看、无法驶入或驶出的封闭水池。
