...
| 海图多尺度三层迷雾 | 新游戏打开完整海图，并在航行画面靠近未知边缘 | 观察背景、中景、细节雾团的尺度、颜色、重复度和海水可见度 | 大量中小雾团以灰蓝、蓝白、灰白三层错落覆盖；各处透明度不同且能隐约看到水墨海纹；无超大重复云块，未知建筑和岛屿不显示 | passed / focused runtime + 1344×896 OpenGL captures 2026-08-18 |
