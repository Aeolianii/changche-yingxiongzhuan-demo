...
| 雾中海怪事件 | 分别固定三种海怪变体并接触雾影 | 观察雾层数秒，依次选择绕行；另选择靠近查看、默认获胜 | 三张透明雾影与立绘一一对应；白雾缓慢流动并轻微呼吸，暗色剪影和透明边缘稳定；初始按钮为“靠近查看 / 绕行”；绕行无奖励；默认获胜显示战胜海怪并获得木材、铁石各 500 | passed / transparent-corner assertions + three-variant branch suite + Vulkan shader capture 2026-08-14 |
