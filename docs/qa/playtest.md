...
| 内侍立绘 | 进入太监传召对白 | 查看对话框右侧 | 显示士兵 `picture.png`，名牌为“内侍” | pending |
| 皇帝占位立绘 | 进入皇帝对白 | 查看对话框右侧 | 显示暗红金边“帝”字占位卡，名牌为“皇帝” | pending |
| 主帅立绘 | 推进至主帅回复 | 查看对话框左侧 | 显示将军 `picture.png`，名牌为“水师主帅” | pending |
| 无角色文本 | 查看旁白、圣旨和错误提示 | 推进或触发文本 | 立绘及名牌隐藏，不残留上一位说话者 | pending |
