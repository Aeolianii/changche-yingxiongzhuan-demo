...
| 海图接取伏波支线 | 未接取时驶近伏波古岭，再驶入岛屿右下方码头入口 | 阅读士兵军情并点击“收到，我会前去巡视。” | 大范围近岛触发防倭巡岛军情；只有右下码头附近显示登岛交互，岛屿下方其他海面不误触；确认后正式接取支线，主线仍为“探索海域，完善海图” | passed / focused side-quest + dock-entry flow 2026-08-12 |
