...
| 海图初始迷雾 | 新游戏从场景二进入海上大地图 | 打开右下完整海图并查看远端四区 | 仅南海军港当前视野已揭示，远端海域全黑且地点名称隐藏 | passed / fog runtime + OpenGL render 1 |
| 航行永久揭示 | 从南海军港沿任意航道持续航行后折返 | 对比航行画面与完整海图 | 点亮范围跟随相机视野，走过航线保持可见且两处遮罩一致 | passed / fog runtime + OpenGL render 1 |
