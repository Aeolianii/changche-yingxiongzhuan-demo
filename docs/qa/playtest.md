...
| 海图永久探索迷雾 | 从县令进入海图，向未开图方向航行并打开完整海图 | 核对已探索方向、未探索方向的视野边缘、黑色未知区和地点标签 | 已探索方向保持明亮；未开图方向只在屏幕最外缘保留约 48 像素窄黑雾，并以轻量水墨渐变衔接；已探索区域永久保留，完整海图只显示已揭示地点 | passed / parser + persistence + sea-scene smoke 2026-08-12 |
