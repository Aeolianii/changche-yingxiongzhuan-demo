...
| 劝降像素水墨提示 | 分别进入教学关、普通关和随机遭遇，满足我方劝降或敌方提议条件 | 查看单按钮与双按钮状态 | 所有关卡均使用 600×150px 横向干笔墨条；20px 金色标题、16px 米白黑描边正文与无常驻矩形框的操作文字居中，无独立宣纸卡片和内容拥挤 | passed / focused assertions + OpenGL captures 2026-08-17 |
