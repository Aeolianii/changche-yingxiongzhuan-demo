...
| 劝降像素水墨牒文 | 战斗中分别满足我方劝降和敌方提议条件 | 查看单按钮与双按钮状态 | 使用 460×144px 透明破边宣纸/墨晕生成底板；20px 金色标题、16px 深褐正文；朱砂主按钮与墨青拒绝按钮居中，无旧矩形卡片和空槽 | passed / focused UI assertions + OpenGL captures 2026-08-17 |
