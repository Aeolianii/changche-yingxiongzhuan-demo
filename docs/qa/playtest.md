...
| 航行白雾与海图黑雾分离 | 在航行画面观察未探索区，再点击右下地图按钮 | 对比相同未探索区域在两处的颜色、轮廓和地点显隐 | 航行画面保持白色战斗水墨雾；完整海图使用纯黑覆盖且不透出未知地形；两处共享探索边界，未探索地点仍隐藏 | passed / focused headless + paired 1344×896 OpenGL captures 2026-08-20 |
