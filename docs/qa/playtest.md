...
| 2026-08-22 / enemy transport bow correction 1 | Codex | 对调敌军一格运输船的东/西与南/北贴图，使画面舰艏和逻辑朝向一致 | 运输船四方向总览、Godot 方向素材专项测试、headless 海战 smoke | 交付用户复核 |
...
- 群岛至少包含五个彼此分离的陆地组件；山体、沙洲和礁群中央不得显示可移动蓝格，岛间透明海面仍须保留左右贯通航路。
