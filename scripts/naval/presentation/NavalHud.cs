...
public partial class NavalHud : CanvasLayer
{
    ...
    private void ApplyInkWash()
    {
        ...
        StyleText(StatusLabel, 20, InkWashTheme.TextInk);
        StyleText(MessageLabel, 15, InkWashTheme.BrownText);
        StyleFloatingText(StatusLabel, 3);
        StyleFloatingText(MessageLabel, 2);
