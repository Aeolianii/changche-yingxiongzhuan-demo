...
func _run() -> void:
	...
	_expect(is_equal_approx(float(hud.call("SurrenderPanelWidth")), 460.0) and is_equal_approx(float(hud.call("SurrenderPanelHeight")), 144.0), "Surrender dispatch must use the compact 460 by 144 layout.")
